Download and save the data file from the following URL https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip 





Unzip the downloaded Data file to disk then read the following files 
*  activity_labels.txt
*  features.txt
*  subject_train.txt
*  X_train.txt
...
The training data and test data are to be combined, and the column names should be modified to become the names read from the file features.txt
Also the activity in the x_train and y_train files should be mapped from the names read in the file activity_labels.txt 

The data in the subject_train.txt and subject_test.txt is to combined to the newly formed dataset then the features with labels containing the words "std" and "mean" are to be kept while the other features are to be dropped
...
##  25     : 409   LAYING            :1944   Min.   :-1.000   
##  21     : 408   SITTING           :1777   1st Qu.: 0.263   
##  26     : 392   STANDING          :1906   Median : 0.277   
##  30     : 383   WALKING           :1722   Mean   : 0.274   
##  28     : 382   WALKING_DOWNSTAIRS:1406   3rd Qu.: 0.288   
##  24     : 381   WALKING_UPSTAIRS  :1544   Max.   : 1.000   
##  (Other):7944                                              
...
##  3rd Qu.:-0.522    3rd Qu.:-0.439    3rd Qu.:-0.417    3rd Qu.:-0.414   
##  Max.   : 1.000    Max.   : 1.000    Max.   : 1.000    Max.   : 1.000   
##                                                                         
...
##  Min.   :-1.000       Min.   :-1.0000      Min.   :-1.0000     
##  1st Qu.:-0.817       1st Qu.: 0.0022      1st Qu.:-0.1319     
##  Median :-0.716       Median : 0.1820      Median :-0.0039     
##  Mean   :-0.496       Mean   : 0.0633      Mean   :-0.0543     
##  3rd Qu.:-0.521       3rd Qu.: 0.2508      3rd Qu.: 0.1030     
##  Max.   : 1.000       Max.   : 1.0000      Max.   : 1.0000     
## 
```
...
Then the average for each feature is calculated across all subjects and activities and the output is stored in the file tidy_data.txt
